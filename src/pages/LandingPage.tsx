...
export default function LandingPage() {
  return (
    <div className="login-container">
      <h2 className="top-tracks-heading">Your Favorites Tracks!</h2>
      <h3>Click here to login and see your favorite tracks on Spotify and turn them into a playlist!</h3>
